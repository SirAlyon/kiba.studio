...
import { _ as _sfc_main$1, F as Footer } from './index-f241a2c0.mjs';
import { _ as _sfc_main$2 } from './index-92c33e93.mjs';
import { _ as _sfc_main$3 } from './index-a7a15999.mjs';
...
const _sfc_main = {
  __name: "portfolio-dark",
  __ssrInlineRender: true,
  setup(__props) {
    useHead({
      titleTemplate: `%s - Portfolio Dark`
    });
    const headerData = {
      title: "Latest Works",
      page: "Portfolio"
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$1), { ref: "navbar" }, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/mobile-app/portfolio-dark.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=portfolio-dark-a0140847.mjs.map
