...
import { _ as _sfc_main$1, a as _sfc_main$5 } from './Footer-aa56144b.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$5), { hideBGCOLOR: "" }, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
...
//# sourceMappingURL=home3-light-5da2ab71.mjs.map
