import { ref, mergeProps, useSSRContext, reactive, computed, unref } from "vue";
import { u as useHead } from "./index-88e9f29c.js";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderClass, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr } from "vue/server-renderer";
...
import "destr";
import "defu";
const KibaLoading_vue_vue_type_style_index_0_scoped_df406aad_lang = "";
const _sfc_main$b = {
  __name: "KibaLoading",
...
const KibaNavbar_vue_vue_type_style_index_0_scoped_66f464fa_lang = "";
const _sfc_main$a = {
  __name: "KibaNavbar",
  __ssrInlineRender: true,
  setup(__props) {
...
const KibaHeroModel_vue_vue_type_style_index_0_scoped_4e4522d1_lang = "";
const _sfc_main$9 = {
...
const KibaHero_vue_vue_type_style_index_0_scoped_372cfa6a_lang = "";
const _sfc_main$8 = {
  __name: "KibaHero",
  __ssrInlineRender: true,
  setup(__props) {
...
const KibaAbout_vue_vue_type_style_index_0_scoped_faa5a837_lang = "";
const _sfc_main$7 = {
  __name: "KibaAbout",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-faa5a837><div class="container" data-v-faa5a837><div class="row align-items-center" data-v-faa5a837><div class="col-lg-5 mb-5 mb-lg-0" data-v-faa5a837><div class="kiba-about-visual kiba-observe" style="${ssrRenderStyle({ "--delay": "0.2s" })}" data-v-faa5a837><div class="kiba-about-box" data-v-faa5a837><div class="kiba-about-icon" data-v-faa5a837><i class="fas fa-shield-alt" data-v-faa5a837></i></div><h3 class="kiba-heading-sm mt-20" data-v-faa5a837>Kiba</h3><p class="kiba-body mt-10" data-v-faa5a837> &quot;Kiba&quot; in giapponese significa zanna. Come l&#39;Akita, razza nota per lealtà e protezione incrollabile, noi proteggiamo i tuoi dati e il tuo business digitale con rigore e dedizione. </p><div class="kiba-divider kiba-divider-center mt-20" data-v-faa5a837></div><div class="kiba-about-values mt-20" data-v-faa5a837><div class="kiba-value-item" data-v-faa5a837><i class="fas fa-lock" data-v-faa5a837></i><span data-v-faa5a837>Privacy First</span></div><div class="kiba-value-item" data-v-faa5a837><i class="fas fa-code" data-v-faa5a837></i><span data-v-faa5a837>Codice Etico</span></div><div class="kiba-value-item" data-v-faa5a837><i class="fas fa-infinity" data-v-faa5a837></i><span data-v-faa5a837>Soluzioni Durature</span></div></div><div class="kiba-about-stat mt-25" data-v-faa5a837><span class="kiba-stat-number" data-v-faa5a837>6+</span><span class="kiba-stat-label" data-v-faa5a837>Anni di esperienza</span></div></div></div></div><div class="col-lg-7" data-v-faa5a837><div class="kiba-about-content" data-v-faa5a837><div class="kiba-label kiba-observe kiba-stagger-1" data-v-faa5a837>La Nostra Filosofia</div><h2 class="kiba-heading-lg mt-15 kiba-observe kiba-stagger-2" data-v-faa5a837> Software etico, fatto per durare </h2><div class="kiba-divider kiba-observe kiba-stagger-3" data-v-faa5a837></div><p class="kiba-body mt-20 kiba-observe kiba-stagger-4" data-v-faa5a837><strong data-v-faa5a837>Kiba.Studio</strong> nasce come laboratorio etico di software. Fondata da un fullstack developer con oltre 6 anni di esperienza su <strong data-v-faa5a837>Laravel, Vue.js, Node e Python</strong>, l&#39;agenzia mette al centro i valori che altri trascurano: <strong data-v-faa5a837>privacy, trasparenza e qualità senza compromessi</strong>. </p><p class="kiba-body mt-15 kiba-observe kiba-stagger-5" data-v-faa5a837> Non siamo una factory che produce siti in serie. Siamo una <strong data-v-faa5a837>boutique tecnica</strong> che crede nel codice come strumento di <strong data-v-faa5a837>libertà</strong>, non di dipendenza. I tuoi dati sono una responsabilità che prendiamo sul serio, non merce da monetizzare. Ogni soluzione che costruiamo è pensata per <strong data-v-faa5a837>emancipare</strong> il tuo business, non per vincolarlo. </p><p class="kiba-body mt-15 kiba-observe kiba-stagger-6" data-v-faa5a837> Lavoriamo con la <strong data-v-faa5a837>serietà giapponese</strong>: ordine, pulizia, struttura, rigore. Il nostro codice parla per noi: testato, documentato, manutenibile. Niente scorciatoie, niente debito tecnico nascosto. Solo soluzioni scalabili, sicure e durature. </p><div class="row mt-30" data-v-faa5a837><div class="col-md-6 kiba-observe kiba-stagger-1" data-v-faa5a837><div class="kiba-about-feature" data-v-faa5a837><i class="fas fa-user-shield kiba-text-primary" data-v-faa5a837></i><h4 class="kiba-heading-sm mt-10" data-v-faa5a837>Privacy First</h4><p class="kiba-small mt-5" data-v-faa5a837> I dati dei tuoi utenti sono una responsabilità sacra. Zero tracking invasivo, zero vendita dati. </p></div></div><div class="col-md-6 kiba-observe kiba-stagger-2" data-v-faa5a837><div class="kiba-about-feature" data-v-faa5a837><i class="fas fa-hand-holding-heart kiba-text-primary" data-v-faa5a837></i><h4 class="kiba-heading-sm mt-10" data-v-faa5a837>Tecnologia Etica</h4><p class="kiba-small mt-5" data-v-faa5a837> Software come strumento di emancipazione. Niente dark patterns, niente dipendenza forzata. </p></div></div></div><div class="kiba-ideal-clients mt-30 kiba-observe" data-v-faa5a837><h4 class="kiba-small" data-v-faa5a837><strong data-v-faa5a837>Clienti ideali:</strong> Start-up, PMI e professionisti che cercano qualità, sicurezza e affidabilità — non progetti &quot;veloci e low-cost&quot;. </h4></div></div></div></div></div></section>`);
    };
  }
};
...
const KibaServices_vue_vue_type_style_index_0_scoped_4c311969_lang = "";
const _sfc_main$6 = {
  __name: "KibaServices",
  __ssrInlineRender: true,
  setup(__props) {
...
const KibaProcess_vue_vue_type_style_index_0_scoped_c740da7f_lang = "";
const _sfc_main$5 = {
  __name: "KibaProcess",
  __ssrInlineRender: true,
  setup(__props) {
...
const KibaTechStack_vue_vue_type_style_index_0_scoped_d962eb78_lang = "";
const _sfc_main$4 = {
...
const KibaPortfolio_vue_vue_type_style_index_0_scoped_3e59eb7d_lang = "";
const _sfc_main$3 = {
...
const KibaContact_vue_vue_type_style_index_0_scoped_32c3fa0e_lang = "";
const _sfc_main$2 = {
  __name: "KibaContact",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (submitSuccess.value) {
        _push(`<div class="kiba-success-message mt-20" data-v-32c3fa0e><i class="fas fa-check-circle me-2" data-v-32c3fa0e></i> Grazie! Il tuo messaggio è stato inviato. Ti risponderemo presto. </div>`);
      } else {
        _push(`<!---->`);
      }
...
const KibaFooter_vue_vue_type_style_index_0_scoped_5a29aad1_lang = "";
const _sfc_main$1 = {
  __name: "KibaFooter",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=home-kiba-57315bee.js.map
