  ...
  setup(__props) {
    useHead({
      link: [
        ...
        { rel: "stylesheet", href: "/assets/css/arch-skin-dark.css" },
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/arch-dark.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=arch-dark-25e4ec42.js.map
