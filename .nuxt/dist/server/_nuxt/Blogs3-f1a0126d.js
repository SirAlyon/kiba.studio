import { mergeProps, useSSRContext, withCtx, createTextVNode, ref, unref, createVNode } from "vue";
...
import { C as CountTo } from "./vue3-count-to.esm-97a09df1.js";
import { _ as __nuxt_component_0$1 } from "./client-only-29ef7f45.js";
import "swiper";
const _imports_0 = "" + __publicAssetsURL("img/slid/002.jpg");
const _sfc_main$4 = {};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(CountTo), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="count"${_scopeId}> </span>`);
          } else {
            return [
...
//# sourceMappingURL=Blogs3-f1a0126d.js.map
