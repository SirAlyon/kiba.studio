  ...
  setup(__props) {
    useHead({
      link: [
        ...
        { rel: "stylesheet", href: "/assets/css/mobile-app-dark.css" }
      ]
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/mobile-app-dark.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=mobile-app-dark-d2522b06.js.map
