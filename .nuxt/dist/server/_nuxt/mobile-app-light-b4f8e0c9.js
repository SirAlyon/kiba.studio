import { _ as __nuxt_component_0, a as __nuxt_component_1 } from "./ScrollToTop-a160cca4.js";
  ...
  setup(__props) {
    useHead({
      link: [
        ...
        { rel: "stylesheet", href: "/assets/css/mobile-app-light.css" }
      ]
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/mobile-app-light.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=mobile-app-light-b4f8e0c9.js.map
